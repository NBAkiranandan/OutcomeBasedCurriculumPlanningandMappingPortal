  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-indigo': '0 0 32px rgba(79,70,229,0.45)',
        'glow-violet': '0 0 32px rgba(124,58,237,0.45)',
        'login-card': '0 32px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.05)',
      },
      animation: {
